...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="static/assets/assets/css/jquery-ui-1.10.3.full.min.css" />
		<link rel="stylesheet" href="static/assets/assets/css/datepicker.css" />
		<link rel="stylesheet" href="static/assets/assets/css/ui.jqgrid.css" />

		<!-- fonts -->

		<link rel="stylesheet" href="static/assets/assets\css\cyrillic.css" />

		<!-- ace styles -->

		<link rel="stylesheet" href="static/assets/assets/css/ace.min.css" />
		<link rel="stylesheet" href="static/assets/assets/css/ace-rtl.min.css" />
		<link rel="stylesheet" href="static/assets/assets/css/ace-skins.min.css" />
		...
		<script src="static/assets/assets/js/ace-extra.min.js"></script>
	<base href="<%=basePath%>">
	<!-- jsp文件头和头部 -->
...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="global/const_list.do" method="post" name="userForm" id="userForm">
			<table border='0'>
				<tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<script src="static/assets/assets/js/bootstrap.min.js"></script>
		<script src="static/assets/assets/js/typeahead-bs2.min.js"></script>

		<!-- page specific plugin scripts -->

		<script src="static/assets/assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="static/assets/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
		<script src="static/assets/assets/js/jqGrid/i18n/grid.locale-en.js"></script>

		<!-- ace scripts -->

		<script src="static/assets/assets/js/ace-elements.min.js"></script>
		<script src="static/assets/assets/js/ace.min.js"></script>
