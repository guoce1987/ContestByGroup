package com.fh.controller.system.global;
...
public class GlobalConstController extends BaseController {
	
	String menuUrl = "global/const.do"; //菜单地址(权限用)
//	@Resource(name="globalConstService")
//	private GlobalConstService globalConstService;
