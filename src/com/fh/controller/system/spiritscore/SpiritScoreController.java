package com.fh.controller.system.spiritscore;
...
/**
 * @ClassName: SpiritScoreController.java
 * @Description: 精神文明
 * @author Guoce
 ...
 */
@Controller
@RequestMapping(value="/spiritscore")
public class SpiritScoreController extends BaseController {
	
	String menuUrl = "spiritscore/list.do"; //菜单地址(权限用)
